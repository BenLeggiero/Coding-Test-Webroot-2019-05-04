...
class Comparable_Number_Array_Extensions_Tests: XCTestCase {
    ...
    func testClosest() {
        ...
        XCTAssertEqual(numbers.closest(to:  -.infinity),  1)
        ...
        XCTAssertEqual(numbers.closest(to:         1.9),  3)
        XCTAssertEqual(numbers.closest(to:           2),  3)
        ...
        XCTAssertEqual(numbers.closest(to:   .infinity), 11)
    }
}
